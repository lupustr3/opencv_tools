...
class TestInfo(object):
    ...
    def __init__(self, xmlnode):
        ...
        self.parseIntMetric(xmlnode, "impl_ipp");
        self.parseIntMetric(xmlnode, "impl_ocl");
        self.parseIntMetric(xmlnode, "impl_plain");

        self.parseStringMetric(xmlnode, "impl_rec_ipp")
        self.parseStringMetric(xmlnode, "impl_rec_ocl")

        self.parseStringMetric(xmlnode, "impl_profile")
    ...
    def get(self, name, units="ms"):
        ...
        if name == "status":
            return self.status
        if name == "impl_profile":
            return self.metrix.get(name)
        if name in ["impl_ipp", "impl_ocl", "impl_plain", "impl_rec_ipp", "impl_rec_ocl"]:
            return self.metrix.get(name)
